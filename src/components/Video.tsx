...
export function Video(props: VideoProps) {
  const { data } = useGetlessonBySlugQuery({
    variables: {
       slug: props.lessonSlug, //corrigir o slug no site
    }
  })
    ...
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[1100px] max-h-[68vh] aspect-video">
          <Player>
            { <Youtube videoId={data.lesson.videoId} key={data.lesson.videoId}/> /*chave para ajuste do video */}
            <DefaultUi />
          </Player>
        </div>  
      </div>
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relexed">
